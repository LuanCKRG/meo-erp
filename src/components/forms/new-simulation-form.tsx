...
import { getEquipmentBrands, getModulesByBrand } from "@/actions/equipments"
...
export function NewSimulationForm({ className }: { className?: string }) {
	...
	// const [modules, setModules] = React.useState<Equipment[]>([])
	...
	// 	queryFn: () => getEquipmentBrands()
	// })

	// const handleBrandChange = async (brandId: string) => {
	// 	if (!brandId) {
	// 		setModules([])
	// 		setValue("moduleId", "", { shouldValidate: true })
	// 		return
	// 	}
	// 	setIsLoadingModules(true)
	// 	setValue("moduleId", "", { shouldValidate: true })
	// 	try {
	// 		const fetchedModules = await getModulesByBrand(brandId)
	...
	// 	if (step === 1) {
	// 		fieldsToValidate = ["systemPower", "currentConsumption", "energyProvider", "brandId", "moduleId"]
	// 	} else if (step === 2) {
	...
	return (
		...
		// 													{...field}
		// 													value={field.value !== undefined ? formatNumber(String(field.value)) : ""}
		...
		// 												<SelectContent>
		// 													{modules.map((module) => (
		// 														<SelectItem key={module.cod} value={String(module.cod)}>
		// 															{module.name}
		// 														</SelectItem>
		// 													))}
		// 												</SelectContent>
		...
		// 														className="pl-9"
		// 														{...field}
		// 														value={field.value !== undefined ? formatAsCurrency(String(field.value)) : ""}
