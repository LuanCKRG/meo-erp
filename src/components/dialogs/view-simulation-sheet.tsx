			...
			<SheetContent className="w-full sm:max-w-lg p-0 overflow-y-auto">
				{isLoading ? (
					...
					<div className="flex flex-col items-center justify-center h-full text-center p-4">
						...
						<h2 className="mt-4 text-xl font-semibold">Erro ao carregar dados</h2>
						<p className="text-muted-foreground mt-2">
							{queryData?.message || (error as Error)?.message || "Não foi possível carregar os detalhes da simulação. Tente novamente."}
						</p>
					</div>
				) : (
					<>
